...
const MoneyLaunder2=()=>{
    ...
    return(
       <div className="mr-80 sticky top-0 bg-black z-10 p-4 mb-60">
         ...
         <label className="text-white font-roboto text-2xl font-normal leading-normal tracking-[0.96px] capitalize">
            Are You Related To A Politician Or A High-Ranking Official?</label>
